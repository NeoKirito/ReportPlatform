...
/// <summary>
/// Diagnostic/manual API target. Production B/S should normally call BusinessPrintRequest instead.
/// </summary>
...
/// Example ActionCode = REGISTRATION_PRINT, StationId = REG-01.
/// </summary>
...
/// <summary>
/// One rendered document routed to one physical printer.
/// Different documents in the same business action may use different artifacts/printers.
/// </summary>
...
/// <summary>
/// A workstation receives one batch containing all outputs for one B/S click.
/// It downloads every distinct artifact once, then queues each document to its mapped printer.
/// </summary>
